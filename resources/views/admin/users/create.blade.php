...
@section('content')
    ...
    <div class="col-12">
        <div class="bg-light rounded h-100 p-4">
            <h6 class="mb-4">{{ trans('global.create') }} {{ trans('cruds.user.title_singular') }}</h6>
            <form action="{{ route("admin.users.store") }}" method="POST" enctype="multipart/form-data">
                ...
                <!--                    <span class="btn btn-info btn-xs select-all-user" id="select-all-user">{{ trans('global.select_all') }}</span>
                    ...
                    <!-- multiple="multiple" size="13" -->
                    <select name="roles[]" id="roles" class="form-control" style="height: 100%;"
                            required>
                ...
                <div id="country_div" class="mb-3 {{ $errors->has('country') ? 'has-error' : '' }}">
                ...
                <div id="currency_div" class="mb-3 {{ $errors->has('currency') ? 'has-error' : '' }}">
                    <label for="currency">Currency</label>
                    <input id="currency" type="text" class="form-control @error('currency') is-invalid @enderror"
                           name="currency" readonly autocomplete="currency">
