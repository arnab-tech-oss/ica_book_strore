...
@section('content')
    <div class="col-12">
        <div class="bg-light rounded h-100 p-4">
            <h6 class="mb-4">  {{ trans('global.create') }} {{ trans('cruds.comment.title_singular') }}</h6>
            <form action="{{ route("admin.comments.store") }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3 {{ $errors->has('author_name') ? 'has-error' : '' }}">
                ...
                <div class="mb-3 {{ $errors->has('author_email') ? 'has-error' : '' }}">
                ...
                <div class="mb-3 remarks_div {{ $errors->has('comment_text') ? 'has-error' : '' }}" s>
