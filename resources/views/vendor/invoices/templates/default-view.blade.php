...
<html lang="en">
    ...
    <body>
        ...
        {{-- Table --}}
        @if(!empty(config('app.setting')) && config('app.setting')['billing_header'])
            <div class="d-flex justify-content-center">
                <p>{{ config('app.setting')['billing_header'] }}</p>
            </div>
            <hr/>
        @endif
        <table class="table">
            ...
            <tbody>
                ...
                @if($invoice->tax_rate)
                    <tr>
                        <td colspan="{{ $invoice->table_columns - 2 }}" class="border-0"></td>
                        <td class="text-right pl-0">GST Rate</td>
                        <td class="text-right pr-0">
                            {{ $invoice->tax_rate }}%
                        </td>
                    </tr>
        ...
        @if(!empty(config('app.setting')) && config('app.setting')['billing_footer'])
            <hr />
            <div class="d-flex justify-content-center">
                <p>{{ config('app.setting')['billing_footer'] }}</p>
            </div>
            <hr/>
        @endif
